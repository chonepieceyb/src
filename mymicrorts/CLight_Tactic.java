 ...
 */
public class CLight_Tactic extends AbstractAction {
    ...
    public CLight_Tactic(Unit u, Unit a_target, Unit h, Unit eb, PathFinding a_pf, UnitTypeTable ut, Player pl) {
        super(u);
        target = a_target;
        pf = a_pf;
        home = h;
    ...
    public boolean equals(Object o) {
        ...
        CLight_Tactic a = (CLight_Tactic) o;
    ...
    public UnitAction execute(GameState gs, ResourceUsage ru) {
        ...
        //Finding light ally and distance from ally to target
        Unit ally = nearestLightAlly(enemyBase, gameUnites, gs);
    ...
    public Unit farthestLightAlly(Unit start, List<Unit> unites, GameState gs) {
        PhysicalGameState pgs = gs.getPhysicalGameState();
    ...
    public Unit nearestLightAlly(Unit start, List<Unit> unites, GameState gs) {
        PhysicalGameState pgs = gs.getPhysicalGameState();
        ...
        if (start != null) {
            for (Unit u2 : unites) {
                if (u2 != null && u2.getPlayer() == p.getID() && u2.getType() == lightType) {
