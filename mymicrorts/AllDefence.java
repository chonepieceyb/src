 ...
 * @author 86158
 */
public class AllDefence extends ai.abstraction.AbstractionLayerAI {
        Random r = new Random();
    ...
    public AllDefence(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }

    public AllDefence(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public void meleeUnitBehavior(Unit u, Player p, GameState gs) {
        ...
        if (closestEnemy != null) {
            if (gs.getTime() < 400 || isRush) {
                ...
                lightTactic(u, closestEnemy, closestBase, closestEnemyBase, utt, p);
            }
        }
    }
        ...
        for (Unit u : freeWorkers) {
            ...
            if (closestResource == null || distance(closestResource, closestEnemyBase) < distance(closestResource, closestBase)) {
                ...
                if (closestResource != null && closestBase != null) {
                    ...
                    if (aa instanceof ai.abstraction.Harvest) {
                        ai.abstraction.Harvest h_aa = (ai.abstraction.Harvest) aa;
    ...
    public void lightTactic(Unit u, Unit target, Unit home, Unit enemyBase, UnitTypeTable utt, Player p) {
        actions.put(u, new CLight_Tactic(u, target, home, enemyBase, pf, utt, p));
    }
