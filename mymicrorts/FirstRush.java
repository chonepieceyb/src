...
//        System.out.println(ef.evaluate(player, 1-player, gs));
...
//        System.out.println(battleWorkers.size()+" "+freeWorkers.size());
        ...
        if ((nbarracks == 0) && (!freeWorkers.isEmpty()) && nworkers > 1
            ...
            int resources = p.getResources();
            Unit u = freeWorkers.remove(0);
            buildIfNotAlreadyBuilding(u,barracksType,u.getX(),u.getY()+3*(p.getID()==0&&u.getY()+3<16?1:0),reservedPositions,p,pgs);
