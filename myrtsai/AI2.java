...
public class AI2 extends AbstractionLayerAI{
    ...
    double alpha= 0.5;
    double r = 0.6;
    String QMatrixFileName = "QMatrix2.txt";
    String rewardMatrixFileName = "rewardMatrix2.txt";
    int timeStep=100;
    int lastTime=0;
    int action;
    int actionNum=8;
    ...
    public PlayerAction getAction(int player, GameState gs) {
       ...
       if(gs.getTime()>=50){
        ...
        if(gs.getTime()==551||gs.getTime()-lastTime>=timeStep){
            ...
            this.workersBehavior(harvestWorkers,buildWorkers, p, pgs,isBuild,1,13,15);
